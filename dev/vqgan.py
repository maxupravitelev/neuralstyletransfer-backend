"""Built based on: https://colab.research.google.com/drive/10V6zIcZznkPLrH1ASa1lFiL5JN192yZ6
"""
...
---
You can ascribe percentage weights to your different prompts by adding a colon and then a number to each one, adding up to 100. For example, “a cityscape:50 | nightmare artist:25 | photorealism:25”

In the text prompt section, adding phases like “unreal engine,” “hyperrealistic,” “photorealistic,” and “render” produces more HD-like results, which is pretty funny.
If you want to add your own images for use in the “initial_image” or “target_images” section, go to the left side of the screen and click on the little File icon. Drag and drop your images into the folder, and then type the name of the folder (e.g. image.jpg, face.png) into the relevant section.

"""

#@title Parámetros
textos = "robotic riots | vray unreal engine hyperrealistic" #@param {type:"string"}
ancho =  700#@param {type:"number"}
